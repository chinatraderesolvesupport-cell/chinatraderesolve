# Установка ChinaTradeResolve v3.7.28 на Render
...
Распакуйте архив `ChinaTradeResolve_Document_AI_v3.7.28.zip`.

В GitHub загрузите **содержимое архива** `ChinaTradeResolve_Document_AI_v3.7.28.zip`. Файлы `app`, `tests`, `requirements.txt`, `Dockerfile` и остальные должны находиться в корне репозитория, как раньше.
