...
GUIDE_DETAIL_COPY = {'en': {'all_guides': 'All guides',
        ...
        'share_failed': 'Copy the address from the browser bar.',
        'home': 'Home'},
 'ru': {'all_guides': 'Все руководства',
        ...
        'share': 'Поделиться руководством',
        'share_copied': 'Ссылка скопирована.',
        'share_failed': 'Скопируйте адрес из строки браузера.',
        'home': 'Главная'},
 'fr': {'all_guides': 'Tous les guides',
        ...
        'share_failed': 'Copiez l’adresse depuis la barre du navigateur.',
        'home': 'Accueil'},
 'de': {'all_guides': 'Alle Ratgeber',
        ...
        'share': 'Ratgeber teilen',
        'share_copied': 'Link kopiert.',
        'share_failed': 'Kopieren Sie die Adresse aus der Browserleiste.',
        'home': 'Startseite'},
 'es': {'all_guides': 'Todas las guías',
        ...
        'share_failed': 'Copie la dirección desde la barra del navegador.',
        'home': 'Inicio'},
 'sr': {'all_guides': 'Svi vodiči',
        ...
        'share_failed': 'Kopirajte adresu iz adresne trake pregledača.',
        'home': 'Početna'}}
