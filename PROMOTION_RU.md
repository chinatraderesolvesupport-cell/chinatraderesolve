...
## Что даёт версия 3.7.53

Все 12 руководств теперь опубликованы на шести языках: русском, английском, французском, немецком, испанском и сербском. Это 72 отдельные индексируемые страницы под реальные поисковые ситуации: невозврат денег, исчезновение продавца, недостача, повреждение, неверная спецификация, закрытый спор Alibaba, сертификаты, таможня и недоставка. Карта сайта и hreflang связывают эквивалентные языковые версии, поэтому Google и Яндекс могут показывать пользователю страницу на языке его запроса.
...
1. После развёртывания откройте `/health` и проверьте версию `3.7.53`.
