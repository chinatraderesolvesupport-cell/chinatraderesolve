...
## Что даёт версия 3.7.50

Сайт сохраняет четыре проверенных руководства на всех шести языках и получает ещё восемь углублённых страниц на русском и английском под реальные поисковые ситуации: невозврат денег, исчезновение продавца, недостача, повреждение, неверная спецификация, закрытый спор Alibaba, сертификаты, таможня и недоставка. Карта сайта и hreflang указывают только на реально существующие переводы. В админ-панели по-прежнему видно, откуда пришла новая заявка.
...
1. После развёртывания откройте `/health` и проверьте версию `3.7.50`.
