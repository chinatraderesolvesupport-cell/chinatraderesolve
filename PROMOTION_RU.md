...
Полный бесплатный план распространения, правила площадок, готовые ответы, календарь LinkedIn, UTM-схема и партнёрское письмо находятся в `TRAFFIC_LAUNCH_KIT_RU.md`.

## 1. Сначала разрешите индексацию

1. После развёртывания откройте `/health` и проверьте версию `3.7.56`.
...
В версии 3.7.56 Яндекс Метрика также фиксирует обезличенные цели воронки: открытие руководства, нажатие «Поделиться», переход к форме, начало и успешную отправку заявки, открытие чата и страницы поддержки. Текст заявки, сообщения и документы в цели не передаются.
